...
//Add a check mark to check if note is done, checkmark appears only on hover and will stay there if checked
//User can change the layout of the notes (at the end)
