# toDoList
Goal: Simple to do list for browser, where we can add new notes, delete or edit existing ones with the feature to automaticly all locally

Current state: 
1)We have an input zone
